import Linked from "../models/LinkendList/Linkend.mjs"
import Array from "../models/Array/Array.mjs"
...
document.addEventListener("DOMContentLoaded", () => {
    const addLinkedList = document.getElementById("btn_AddLinkedList");
    const addArrayList = document.getElementById("btn_AddArrayList");
    const searchArrayList = document.getElementById("btn_searchArrayList");
    const searchLinkedList = document.getElementById("btn_searchLinkedList");
    const searchInput = document.getElementById("searchItem");
    const numItemsInput = document.getElementById("noItems");

    const bubbleSortArray = document.getElementById("btn_BubbleArray");
    const mergeSortArray = document.getElementById("btn_MergeArray");
    const radixSortArray = document.getElementById("btn_RadixArray");
    const bubbleSortLinkedList = document.getElementById("btn_BubbleLinked");
    const mergeSortLinkedList = document.getElementById("btn_MergeLinked");
    const radixSortLinkedList = document.getElementById("btn_RadixLinked");
